...
<body>
    ...
    <ul>  
        <li class="nav-item">
            <a href="main.html" target="iframe"><i class="my-icon nav-icon icon_1"></i><span>首页</span></a>
        </li>
        <li class="nav-item">
            <a href="check.html" target="iframe"><i class="my-icon nav-icon icon_2"></i><span>买单结算</span></a>
        </li>
        <li class="nav-item">
            <a href="serviceHelp.html" target="iframe"><i class="my-icon nav-icon icon_3"></i><span>前台服务</span></a>
        </li>
        <li class="nav-item">
